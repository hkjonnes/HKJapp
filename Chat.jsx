  ...
  return (
    <div className="container p-4">
      ...
      <div className="flex gap-2">
        <input value={input} onChange={e=>setInput(e.target.value)} className="flex-1 border p-1 rounded" placeholder="Type message..." />
        <button onClick={sendMessage} className="bg-purple-500 text-white px-3 rounded">Send</button>
      </div>
    </div>
  );
}
